...
public class GenTableColumn extends DataEntity<GenTableColumn>
{
  ...
  public String getDictType() {
    if (this.dictType == null) return ""; return this.dictType;
  }
  ...
  public String getDataLength()
  {
    String[] ss;
    if (((
      ss = StringUtils.split(StringUtils.substringBetween(getJdbcType(), "(", ")"), ",")) != null) && 
      (ss.length == 1)) {
      return ss[0];
    }
    return "0";
  ...
  public String getJavaFieldName()
  {
    String[][] ss;
    if ((
      ss = getJavaFieldAttrs()).length > 0)
      return getSimpleJavaField() + "." + ss[0][0]; return "";
  }
  ...
  public String[][] getJavaFieldAttrs()
  {
    ...
    String[][] sss = new String[(
      ss = StringUtils.split(StringUtils.substringAfter(getJavaField(), "|"), "|")).length][
      2];
    if (ss != null) {
