 ...
 */
package com.lianda.modules.act.service.ext;
...
import com.lianda.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.lianda.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.lianda.modules.sys.entity.User(null, userId)))){
