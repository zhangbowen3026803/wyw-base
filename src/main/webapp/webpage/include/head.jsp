<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.banko.com.cn/"/>
...
<!-- lianda -->
<link href="${ctxStatic}/common/lianda.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/lianda.js" type="text/javascript"></script>
